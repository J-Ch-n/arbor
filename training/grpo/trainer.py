        ...
        if self.vllm_mode == "server":
            if self.accelerator.is_main_process:
                ...
                self.vllm_client = VLLMClient(
                    ...
                    group_port=args.vllm_server_group_port,
...
def parse_args():
    ...
    parser.add_argument("--vllm_server_group_port", type=int, required=True)
...
def build_trainer_config(args: argparse.Namespace) -> ArborGRPOConfig:
    ...
    cfg["vllm_server_group_port"] = args.vllm_server_group_port
